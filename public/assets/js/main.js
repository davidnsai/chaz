(function ($) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (typedEl) {
      new Typed(typedEl, {
        strings: [
          '<span class="highlight">Business and Economics</span>',
          '<span class="highlight">Education</span>',
          '<span class="highlight">Law</span>',
          '<span class="highlight">Health Sciences</span>',
          '<span class="highlight">Humanities and Social Sciences</span>',
          '<span class="highlight">Natural Sciences</span>',
        ],
        typeSpeed: 120,
        backSpeed: 60,
        startDelay: 0,
